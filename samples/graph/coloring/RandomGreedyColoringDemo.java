...
*                   - Arizona State University
*
* File : RandomGreedyColoringDemo.java
*           Basic Program to illustrate use of RandomGreedyColoring
*
...
import com.graph.coloring.RandomGreedyColoring;
...
public class RandomGreedyColoringDemo
{
    private final String GRAPH_FOLDER = "inputs/";

    protected RandomGreedyColoringDemo()
    {
    ...
    System.out.println("---------------- RANDOM GREEDY COLORING -----------------");
    ...
    RandomGreedyColoring greedy_algorithm;
    int coloring[];
    ...
    timer.start();
        ...
        greedy_algorithm = new RandomGreedyColoring(G);
    ...
    {
        RandomGreedyColoringDemo demo = new RandomGreedyColoringDemo();
        demo.driver();
    }
}
