...
*                   - Arizona State University
*
* File : LargestDegreeFirstColoringDemo.java
*           Basic Program to illustrate use of LargestDegreeFirstColoring
*
...
import com.graph.coloring.LargestDegreeFirstColoring;
...
public class LargestDegreeFirstColoringDemo
{
    private final String GRAPH_FOLDER = "inputs/";

    protected LargestDegreeFirstColoringDemo()
    {
    ...
    System.out.println("---------------- LARGEST DEGREE COLORING -----------------");
    ...
    LargestDegreeFirstColoring greedy_algorithm;
    int coloring[];
    ...
    timer.start();
        ...
        greedy_algorithm = new LargestDegreeFirstColoring(G);
    ...
    {
        LargestDegreeFirstColoringDemo demo = new LargestDegreeFirstColoringDemo();
        demo.driver();
    }
}
