...
*                   - Arizona State University
*
* File : InsertionSortDemo.java
*          Demo program to demonstrate the implementation of InsertionSort
*
...
import com.clrs.sorting.InsertionSort;
...
public class InsertionSortDemo
{
    ...
    public static void main(String args[])
    {
        System.out.println("                    " + Config.getProgramInfo() + "                    ");
            ...
            InsertionSortDemo d = new InsertionSortDemo();
            d.driver();
    }
}
