...
*                   - Arizona State University
*
* File : CanonicalParser.java
*           Class to extract Canonical Arrays
*
...
/**
* A Parser for Canonical Arrays.
* <p>
* Canonical Arrays are of the following form <br>
...
*/
class CanonicalParser extends CAParser
{
    /**
    ...
    */ 
    protected CanonicalParser(File CA_FILE)
    {
    ...
    * per the reliability.
    */
    protected CanonicalParser(File CA_FILE, boolean ENSURE_COVERAGE)
    {
        this.CA_FILE = CA_FILE;
    ...
    * of the Canonical covering array.
    ...
    */
    ...
    /**
    * This method attempts to extract parameters from the file name of the Canonical array.
    * <p>
    * If this method returns true, the parameters (N,t,k,v) are available to the program.
    * @return true if the parameters were extracted, false if the file name contained exceptions to Canonical Arrays.
    */
    ...
    String file_name;
        ...
        String params[] = file_name.split("_");

            this.parameters.t = Byte.parseByte(params[0]);
    ...
    /**
    * This method attempts to extract the Canonical covering array from the file.
    * <p>
    ...
    */
    ...
    int row;
        ...
        line = file_reader.readLine();
            ...
            if(line.contains(" --> "))
            this.parameters.N = Integer.parseInt(line.split(" --> ")[1]);
            else
