...
*                   - Arizona State University
*
* File : NistParser.java
*           Class to extract NIST Arrays
*
...
/**
* A Parser for NIST Arrays.
* <p>
* NIST Arrays are of the following form <br>
...
*/
class NistParser extends CAParser
{
    /**
    ...
    * per the reliability.
    */
    protected NistParser(File CA_FILE, boolean ENSURE_COVERAGE)
    {
        this.CA_FILE = CA_FILE;
    ...
    */
    ...
    /**
    * This method attempts to extract parameters from the file name of the NIST array.
    * <p>
    * If this method returns true, the parameters (N,t,k,v) are available to the program.
    * @return true if the parameters were extracted, false if the file name contained exceptions to NIST Arrays.
    */
    ...
    String file_name;
        ...
        String params[] = file_name.split(",");
            ...
            this.parameters.v = Byte.parseByte(params[1]);
    ...
    /**
    * This method attempts to extract the NIST covering array from the file.
    * <p>
